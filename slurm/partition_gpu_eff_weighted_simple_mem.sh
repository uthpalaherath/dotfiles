#!/usr/bin/env bash
# partition_gpu_eff_weighted_simple_mem.sh
#
...
#
# Usage:
#   ./partition_gpu_eff_weighted_simple_mem.sh -p PARTITION -s STARTDATE -e ENDDATE
#
# Example:
#   ./partition_gpu_eff_weighted_simple_mem.sh -p h200alloc -s 2025-12-01 -e 2025-12-09
