...
# tmux
export TMUX_DEVICE_NAME=hybrid3-server
...
export FZF_DEFAULT_COMMAND='rg --files --type-not sql --smart-case --follow --hidden -g "!{node_module
export FZF_DEFAULT_OPTS="--preview 'bat --color=always --style=numbers {} 2>/dev/null || cat {} 2>/dev/null
...
update_db(){
   mysql -u uthpala -puthpala1234 -Bse "DROP DATABASE IF EXISTS $1;CREATE DATABASE $1;"
   mysql -u uthpala -puthpala1234 $1 < $2
}
...
export PATH="/home/ukh/local/ripgrep/:$PATH"
export PATH="/home/ukh/local/bat/:$PATH"
